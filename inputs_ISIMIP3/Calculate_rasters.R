...
G_areas <- read.csv("../Hypsographics/GLOBathy/Results/GLOBATHY_hypso_areas_representative.csv", header=F)
G_level <- read.csv("../Hypsographics/GLOBathy/Results/GLOBATHY_hypso_levels_representative.csv", header=F)
G_volume <- read.csv("../Hypsographics/GLOBathy/Results/GLOBATHY_hypso_volumes_representative.csv", header=F)
G_id <- read.csv("../Hypsographics/GLOBathy/Results/GLOBATHY_lakes_ID_representative.csv", header=F)
...
G_fitareas <- read.csv("../Hypsographics/GLOBathy/Results/GLOBATHY_hypso_fitArea_representative.csv", header=F)
G_fitvolume <- read.csv("../Hypsographics/GLOBathy/Results/GLOBATHY_hypso_fitVolume_representative.csv", header=F)
